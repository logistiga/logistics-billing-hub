...
class OrdreTravailController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            // Champs booking
            'numero_booking' => 'nullable|string|unique:ordres_travail,numero_booking',
            'numero_connaissement' => 'nullable|string',
            'navire' => 'nullable|string',
            'compagnie_maritime' => 'nullable|string',
            'transitaire' => 'nullable|string',
            'nombre_conteneurs' => 'nullable|integer|min:0',
            'prime_transitaire' => 'nullable|numeric|min:0',
            'prime_representant' => 'nullable|numeric|min:0',
            // Champs intégration externe
            ...
            'lignes_prestations.*.type_operation' => 'nullable|string',
            'lignes_prestations.*.sous_type' => 'nullable|string',
            'lignes_prestations.*.point_depart' => 'nullable|string',
            'lignes_prestations.*.point_arrivee' => 'nullable|string',
            'lignes_prestations.*.date_debut' => 'nullable|date',
            'lignes_prestations.*.date_fin' => 'nullable|date',
    ...
    public function update(Request $request, OrdreTravail $ordreTravail)
    {
        $validated = $request->validate([
            ...
            // Champs booking
            'numero_booking' => 'nullable|string|unique:ordres_travail,numero_booking,' . $ordreTravail->id,
            'numero_connaissement' => 'nullable|string',
            'navire' => 'nullable|string',
            'compagnie_maritime' => 'nullable|string',
            'transitaire' => 'nullable|string',
